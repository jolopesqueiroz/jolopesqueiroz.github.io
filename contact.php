            ...
            <header class="header box">
                <div class="header__left">
                    <div class="header__photo">
                        <img class="header__photo-img" src="assets/img/profile.jpeg" alt="Jo Lopes Queiroz">
                    </div>
                ...
                <div class="header__right">
                    <ul class="header__contact">
                        ...
                        <li>
                            ...
                            <a href="https://api.whatsapp.com/send?phone=5515999999999" target="_blank"> +55 (15)
                                99999-9999 </a>
                        </li>
                    </ul>
                    <ul class="header__contact">
            ...
            <div class="row sticky-parent">
                ...
                <aside class="col-12 col-md-12 col-lg-2">
                    <div class="sidebar box sticky-column">
                        <ul class="nav">
                            <li class="nav__item"><a class="active" href="index.php"><i class="icon-user"></i>Sobre
                                    Mim</a></li>
                            ...
                            <!--<li class="nav__item"><a href="blog.php"><i class="icon-book-open"></i>Blog</a></li>-->
